...
ADMIN_ID      = ADMIN_IDS[0]          # primary admin (backward-compat)
...
cmd_control_col       = db["cmd_controls"]      # command on/off per group/global
lang_settings_col     = db["lang_settings"]     # group language preferences
...
# সমস্ত crypto/USDT wallet address এবং QR code সরিয়ে দেওয়া হয়েছে।
# Telegram ToS অনুযায়ী শুধুমাত্র Telegram Stars payment ব্যবহার করা হবে।
