...
async def tagall_cmd(client: Client, message: Message):
    ...
    # Mention in batches of 5 per message
    # Delay বাড়ানো হয়েছে flood limit এড়াতে
    BATCH = 5
    MAX_MEMBERS = 200  # অনেক বেশি message পাঠালে ban হওয়ার ঝুঁকি থাকে
    ...
    for i in range(0, len(members), BATCH):
        ...
        try:
            ...
            continue
        await asyncio.sleep(3.0)   # flood limit এড়াতে যথেষ্ট delay
