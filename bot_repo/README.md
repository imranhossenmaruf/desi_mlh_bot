...
An advanced Telegram bot for group management, anti-spam, and community tools. Manage multiple groups from a single **Control Group**. Built with [Pyrogram](https://pyrogram.org/) and MongoDB.
...
| 🏷️ Tag Members | Tag all members with standard @mention |
...
| 💎 Premium System | Tiered packages, Telegram Stars payment |
...
| Command | Description |
|---|---|
| `/taggroup [gid] [msg]` | Tag all members in a specific group |
...
| Package | Stars | Duration | Videos/Day |
|---|---|---|---|
| 🌱 Starter | 100 ⭐ | 3 days | 15 |
| 🥉 Basic | 250 ⭐ | 7 days | 30 |
| 🥈 Standard | 500 ⭐ | 30 days | 60 |
| 🥇 Pro | 900 ⭐ | 60 days | 100 |
| 💎 VIP | 1250 ⭐ | 90 days | Unlimited |
| 👑 Elite | 2000 ⭐ | 180 days | Unlimited |

**Payment Method:** Telegram Stars ⭐ (instant activation — no manual approval needed)
...
└── handlers/
    ...
    ├── tagger.py            # 🏷️ Tag system (standard mentions)
    ...
    ├── premium.py           # 💎 Premium packages (Stars only)
